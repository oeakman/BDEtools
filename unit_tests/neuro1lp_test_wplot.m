function [solerr, solcell, solSercell] = neuro1lp_test_wplot
% function [solerr, solcell, solSercell] = neuro1lp_test_wplot
%
% NEURO1LP_TEST_WPLOT   Test function for the BDE solver - 1-loop Neurospora model of Akman et al. 
%                       This version also plots the parallel & serial solutions for comparison.
%
% [solerr, solcell, solSercell] = neuro1lp_test_wplot
% [~, ~, solSercell] = neuro1lp_test_wplot
%
% OUTPUTS 
%
...
for k=1:2
    ...
    box on;
    xticks(0:4:tEnd); 
    yticks([0 0.1 0.2 1 1.1 1.2]); 
    yticklabels({'0', '0', '0', '1', '1', '1'}); 
    xlabel('Time, t (h)');
    ylabel('Expression (0/1)');
    set(gca, 'FontSize', 12);
    legend({'frq', 'FRQ', 'L'}, 'Orientation', 'Horizontal', 'Location', 'North', 'FontSize', 18);
end
